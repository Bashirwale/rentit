  ...
  return (
    <div className="w-full mt-6 overflow-hidden px-8">
      ...
      <div className="flex items-center justify-between md:justify-evenly mt-2">
        <img src={techC} alt="trusted by" className="h-6 md:h-8" />
        <img src={forbes} alt="trusted by" className="h-6 md:h-8" />
        <img src={entrepreneur} alt="trusted by" className="h-6 md:h-8" />
        <img src={techtimes} alt="trusted by" className="h-6 md:h-8" />
        <img src={thewall} alt="trusted by" className="h-6 md:h-8" />
      </div>
    </div>
  );
};
