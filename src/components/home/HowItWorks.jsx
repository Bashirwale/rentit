...
const HowItWorks = () => {
  return (
    <div className="py-12 px-8 md:px-16">
      ...
      <p className="text-sm font-normal text-neutral-500 text-center md:text-left w-2/4">
      ...
      <div className="mt-8">
        <div className="flex items-center gap-10 py-2 border-b-neutral-300">
          ...
          <p className="text-base font-semibold text-neutral-500 border-b border-b-neutral-300 p-4 w-full">
